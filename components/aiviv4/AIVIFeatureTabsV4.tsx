...
export default function AIVIFeatureTabsV4() {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full relative overflow-hidden px-6 sm:px-12 md:px-16 lg:px-24 py-20 sm:py-28 md:py-32 font-manrope"
      style={{ background: 'linear-gradient(180deg, #ffffff 0%, #fafafa 50%, #f5f5f7 100%)' }}
    ...
    >
      ...
      <div className="w-full relative z-10">
        ...
        <div ref={headerRef} className="text-center mb-14 sm:mb-18">
          ...
          <div className="inline-flex items-center gap-3 px-5 py-2.5 mb-8 rounded-full bg-gradient-to-r from-[#f84608]/5 to-[#321ca3]/5 border border-[#f84608]/10">
            <span className="w-2.5 h-2.5 rounded-full bg-gradient-to-r from-[#f84608] to-[#321ca3] animate-pulse" />
            <span className="text-[13px] font-semibold tracking-[2px] uppercase text-[#f84608]">
              How It Works
            </span>
          </div>
